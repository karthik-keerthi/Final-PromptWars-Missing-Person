...
const resources = {
  en: {
    translation: {
      ...
      "image_placeholder": "https://... or upload a file",
      "image_too_large": "Image file is too large. Please upload an image smaller than 1MB.",
      "embedding_error": "Failed to process image for facial recognition. Please try a different image or upload a file directly.",
  ...
  hi: {
    translation: {
      ...
      "image_placeholder": "https://... या फ़ाइल अपलोड करें",
      "image_too_large": "छवि फ़ाइल बहुत बड़ी है। कृपया 1MB से छोटी छवि अपलोड करें।",
      "embedding_error": "चेहरे की पहचान के लिए छवि को संसाधित करने में विफल। कृपया एक अलग छवि आज़माएं या सीधे फ़ाइल अपलोड करें।",
  ...
  te: {
    translation: {
      ...
      "image_placeholder": "https://... లేదా ఫైల్‌ను అప్‌లోడ్ చేయండి",
      "image_too_large": "చిత్రం ఫైల్ చాలా పెద్దది. దయచేసి 1MB కంటే చిన్న చిత్రాన్ని అప్‌లోడ్ చేయండి.",
      "embedding_error": "ముఖ గుర్తింపు కోసం చిత్రాన్ని ప్రాసెస్ చేయడంలో విఫలమైంది. దయచేసి వేరే చిత్రాన్ని ప్రయత్నించండి లేదా నేరుగా ఫైల్‌ను అప్‌లోడ్ చేయండి.",
